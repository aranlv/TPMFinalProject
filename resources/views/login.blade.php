        ...
        <div class="right-side  larger-form">
            ...
            <form class="login" action="">
                <div class="input-box">
                    ...
                    <input type="text" name="" class="fill-area" id="teamName" placeholder="Input your team name">
                </div>
                <p id="nameErrorMessage" class="error-message"></p>
                <div class="input-box">
                    <img src="{{ asset('assets/images/lock.png') }}" alt="" class="icon">
                    <input type="password" name="" class="fill-area password-input" id="password" placeholder="Password">
                </div>
